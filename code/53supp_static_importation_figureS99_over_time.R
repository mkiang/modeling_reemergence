...
supp_result <- dplyr::tbl(con, "read_parquet('supp_analyses/static_importation_summary.parquet')") |>
    ...
    dplyr::mutate(result_type = "static_importation") |>
    dplyr::collect()
...
results_df <- us_final |>
    ...
    dplyr::mutate(result_cat = factor(result_type,
        ...
        labels = c("Static importation", "Primary result"),
        ordered = TRUE
    )) |>
...
## Save ----
ggplot2::ggsave(
    here::here("plots", "figS99_static_importation_over_time.pdf"),
    p1,
    width = 14,
    height = 8,
    scale = 1,
...
ggplot2::ggsave(
    here::here("plots", "figS99_static_importation_over_time.jpg"),
    p1,
    width = 14,
    height = 8,
    scale = 1,
