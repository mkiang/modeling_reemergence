...
p1 <- ggplot2::ggplot(
    ...
    # ggh4x::facet_grid2(vars(pathogen_cat),
    #     vars(vaccine_coverage_cat),
    #     scales = "free_y",
    #     independent = "y"
    # ) +
    mk_nytimes(
...
## Save ----
ggplot2::ggsave(
    here::here("plots", "figS99_diphtheria_novrt_over_time.pdf"),
    p1,
    width = 10,
    height = 6,
    scale = 1,
...
ggplot2::ggsave(
    here::here("plots", "figS99_diphtheria_novrt_over_time.jpg"),
    p1,
    width = 10,
    height = 6,
    scale = 1,
